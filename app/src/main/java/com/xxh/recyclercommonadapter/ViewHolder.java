...
import com.pinxiango.store.utils.MyImageLoader;
...
//     * @return
//     */
//    public ViewHolder setImageCorner(int viewId, String path){
//        ImageView imageView = getView(viewId);
//        MyImageLoader.getInstance().displayImageConerholder(mContext,path,imageView, R.drawable.probg,R.drawable.probg);
//        return this;
//    }


    public ViewHolder setImageRadius(int viewId, String path){
        ImageView imageView = getView(viewId);
        MyImageLoader.getInstance().displayImageConerHolder(mContext,path,imageView, R.drawable.probg,R.drawable.probg);
        return this;
    }
